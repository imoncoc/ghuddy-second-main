      ...
      <div className="w-full custom-banner-background">
        <div className="custom-banner-background h-[379px]">
          <div className="xl:max-w-[1100px] md:max-w-[765px] md:px-[16px] max-w-[343px] px-[0px] xl:px-[0px] h-[300px]  mx-auto">
            <h2 className="text-[32px] font-medium text-txt-secondary text-start md:text-center pt-[130px] tracking-[0.96px] pb-4">
              Bangladesh, Dhaka
            </h2>
            ...
            <div className="hidden flex-row px-[1px] md:flex items-center justify-between bg-bg-primary h-[44px] text-base16 rounded-full">
              ...
              <div className="flex flex-row items-center h-[40px] border-[1px] py-[14x] px-[6px] rounded-full">
                Go!
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="12"
